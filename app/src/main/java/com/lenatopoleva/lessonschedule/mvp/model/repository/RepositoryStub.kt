...
class RepositoryStub: IRepository {
    ...
    private val lessons = listOf<Lesson>(
        Lesson("Math", "09:30", "11:00", "https://python-scripts.com/wp-content/uploads/2020/01/math-python-libs.jpg", false, null,true),
        ...
        Lesson("Computer Science", "15:30","20:00", "https://www.eschoolnews.com/files/2016/12/computer-science-education-768x768.jpg", false, null,false),
        Lesson("Chemistry", "21:00", "21:30", "https://previews.123rf.com/images/helenfield/helenfield1605/helenfield160500747/56423493-chemistry-pharmacology-natural-sciences-vector-doodle-set-hand-drawn-images.jpg", false, null,false)
    )
    ...
    override fun getExamsDate(): Single<String> = Single.just("01 Jan 2022 00:00:00 GMT")
